...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        hboxButtons.setPreferredSize(new Dimension(new Double(hboxButtons.getMaximumSize().getWidth()).intValue(), new Double(hboxButtons.getMinimumSize().getHeight()).intValue() << 1));
